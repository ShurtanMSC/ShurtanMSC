package uz.neft.backup.my.services;

import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import uz.neft.backup.my.model.InformationSchemaGenerator;
import uz.neft.backup.my.model.InformationSchemaSequence;
import uz.neft.backup.my.model.InformationSchemaTable;
...
public class PostgresqlBaseService {
    ...
    static List<InformationSchemaGenerator> getAllSequences(Statement stmt) throws SQLException {
        ...
        while (rs.next()) {
            sequences.add(
                    InformationSchemaSequence.InformationSchemaSequenceBuilder.anInformationSchemaSequence()
    ...
    static List<InformationSchemaGenerator> getAllTables(Statement stmt) throws SQLException {
        ...
        while (rs.next()) {
            table.add(
                    InformationSchemaTable.InformationSchemaTableBuilder.anInformationSchemaTable()
